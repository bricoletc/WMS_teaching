...
def plot_windowed_pi(pi, bins, title=None, dest=os.path.join(plot_dir, "nuc_diversity.pdf")):
    """
...
gt_clean = gt[non_het_variants] ## filter out sites with heterozygous calls, because TB is haploid
...
pi,windows, n_bases, n_counts= allel.windowed_diversity(pos, allele_counts, size = window_size, start = pos[0], stop = pos[-1])
